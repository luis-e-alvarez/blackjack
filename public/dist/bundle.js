...
/******/ 	__webpack_require__.p = "/Users/luisalvarez/Desktop/Code/Lyft Apprenticeship/public/dist";
/******/
...
var _blackjack = __webpack_require__(142);

var _blackjack2 = _interopRequireDefault(_blackjack);

var _gameplay = __webpack_require__(161);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: 'enterName',
    value: function enterName(value) {
      var splitName = value.split(' ');
      splitName.forEach(function (val, index) {
        splitName[index] = val[0].toUpperCase() + val.slice(1, val.length).toLowerCase();
      });
      var correctedName = splitName.join(' ');
      this.setState({
        name: correctedName
      });
    }
    ...
    value: function conditionalRender() {
      if (this.state.name === '') {
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_nameInput2.default, { enterName: this.enterName.bind(this) })
        );
      }
      if (this.state.id === '') {
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_blackjack2.default, { startGame: this.startGame.bind(this), name: this.state.name })
        );
      }
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_gameplay2.default, { id: this.state.id, name: this.state.name })
      );
    }
  }, {
    key: 'render',
...
var m=__webpack_require__(12),n=__webpack_require__(19),p=__webpack_require__(1),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var _bootstrapUtils = __webpack_require__(103);
...
*/
var aa=__webpack_require__(18),l=__webpack_require__(51),B=__webpack_require__(12),C=__webpack_require__(1),ba=__webpack_require__(52),da=__webpack_require__(53),ea=__webpack_require__(54),fa=__webpack_require__(55),ia=__webpack_require__(56),D=__webpack_require__(19);
...
var _elementType = __webpack_require__(123);
...
var _SafeAnchor = __webpack_require__(140);
...
var _Col = __webpack_require__(129);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { xs: 12, md: 8 },
            'Enter your name: ',
            _react2.default.createElement('input', { value: this.state.name, onChange: this.update.bind(this), id: 'input' }),
            _react2.default.createElement(
              _Button2.default,
              { id: 'pull-left', onClick: this.clicked.bind(this), bsStyle: 'primary' },
              'Submit Name'
            )
          )
        )
...
var _createChainedFunction = __webpack_require__(141);
...
var BlackJack = function (_React$Component) {
  _inherits(BlackJack, _React$Component);

  function BlackJack(props) {
    _classCallCheck(this, BlackJack);

    var _this = _possibleConstructorReturn(this, (BlackJack.__proto__ || Object.getPrototypeOf(BlackJack)).call(this, props));
...
var GamePlay = function (_React$Component) {
  ...
  _createClass(GamePlay, [{
    ...
    value: function beginGame() {
      ...
      _axios2.default.post('/draw', {
        id: this.props.id,
        numberOfCardsToDraw: 4
      }).then(function (response) {
        var playerVals = [response.data[0].value, response.data[1].value];
        var playerImages = [response.data[0].image, response.data[1].image];
        var compVals = [response.data[2].value, response.data[3].value];
        var compImages = [response.data[2].image, response.data[3].image];
        _this2.setState({
          playerValues: [].concat(playerVals),
          playerImages: [].concat(playerImages),
          compValues: [].concat(compVals),
          compImages: [].concat(compImages)
        });
      }).then(function () {
        var playerScore = _this2.state.playerValues.reduce(function (acc, cum) {
          if (cum === 'JACK' || cum === 'KING' || cum === 'QUEEN') {
            return 10 + acc;
          } else if (cum === 'ACE') {
            var input = prompt('Your hand has an Ace! Would you like it to equal 1 or 11? Your current hand has ' + _this2.state.playerValues);
        ...
        var compScore = _this2.state.compValues.reduce(function (acc, cum) {
          if (cum === 'JACK' || cum === 'KING' || cum === 'QUEEN') {
            return 10 + acc;
          } else if (cum === 'ACE') {
            if (acc <= 10) {
    ...
    value: function hit() {
      ...
      _axios2.default.post('/draw', {
        ...
        var playerImages = [].concat(_toConsumableArray(_this3.state.playerImages), [response.data[0].image]);
        var playerValues = [].concat(_toConsumableArray(_this3.state.playerValues), [response.data[0].value]);
        _this3.setState({
          playerImages: [].concat(_toConsumableArray(playerImages)),
          playerValues: [].concat(_toConsumableArray(playerValues))
        });
      }).then(function () {
        var playerScore = _this3.state.playerValues.reduce(function (acc, cum) {
          if (cum === 'JACK' || cum === 'KING' || cum === 'QUEEN') {
            return 10 + acc;
          } else if (cum === 'ACE') {
            var input = prompt('Your hand has an Ace! Would you like it to equal 1 or 11? Your current hand is ' + _this3.state.playerValues);
            return parseInt(input) + acc;
          }
          return parseInt(cum) + acc;
        }, 0);
        ...
        _this3.checkIfPlayerLostGame();
      });
    }
  }, {
    key: 'checkIfPlayerLostGame',
    value: function checkIfPlayerLostGame() {
    ...
    key: 'checkIfComputerOrPlayerWonGame',
    value: function checkIfComputerOrPlayerWonGame() {
    ...
    key: 'stay',
    value: async function stay() {
      if (this.state.compScore <= 18) {
        var response = await _axios2.default.post('/draw', {
          id: this.props.id,
          numberOfCardsToDraw: 1
        });
        var compImages = [].concat(_toConsumableArray(this.state.compImages), [response.data[0].image]);
        var compValues = [].concat(_toConsumableArray(this.state.compValues), [response.data[0].value]);
        this.setState({
          compImages: [].concat(_toConsumableArray(compImages)),
          compValues: [].concat(_toConsumableArray(compValues))
        });
        var compScore = this.state.compValues.reduce(function (acc, cum) {
          if (cum === 'JACK' || cum === 'KING' || cum === 'QUEEN') {
            return 10 + acc;
          } else if (cum === 'ACE') {
            if (acc <= 10) {
      ...
      if (this.state.newGame === true) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  _Button2.default,
                  { onClick: this.hit.bind(this), bsStyle: 'primary' },
                  ' Hit '
                ),
                _react2.default.createElement(
                  _Button2.default,
                  { onClick: this.stay.bind(this), bsStyle: 'primary' },
                  ' Stay '
                )
              )
            )
          ...
          _react2.default.createElement(
            _Row2.default,
            null,
            this.state.playerImages.map(function (image) {
              return _react2.default.createElement(
                _Col2.default,
                { xs: 6, md: 4 },
                _react2.default.createElement(_card2.default, { image: image })
              );
            })
          ),
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Row2.default,
            null,
            this.state.compImages.map(function (image) {
              return _react2.default.createElement(
                _Col2.default,
                { xs: 6, md: 4 },
                _react2.default.createElement(_card2.default, { image: image })
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                _Button2.default,
                { onClick: this.newGame.bind(this), bsStyle: 'primary' },
...
var _CloseButton = __webpack_require__(163);
...
var CardImage = function CardImage(props) {
  return _react2.default.createElement(
    "div",
    null,
    _react2.default.createElement("img", { className: "media-object", src: props.image, alt: "" })
  );
};
